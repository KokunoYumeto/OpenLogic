% Penggerak mandiri untuk bab Deduksi Alami dalam pelokalan Bahasa
% Indonesia. Penggerak ini membatasi build pada OLP-0084--OLP-0097.
...
% Upstream's deferred-problem wrapper can place consecutive problem headings
% on the same output line after a terminating list.  Force a paragraph break
% between deferred problems in this bounded reader build.
...
% OLP-0095 dan OLP-0097 merujuk hasil dari bab sintaks dan semantik orde
